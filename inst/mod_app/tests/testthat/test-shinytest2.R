...
test_that("{shinytest2} recording: mod_app", {
  app <- AppDriver$new(name = "mod_app", seed = 123, height = 929, width = 1619)
  app$expect_values()
  app$set_inputs(`app-chat-prompt-chat_input` = "return to me just the 'random' in plain text. make no comments about it.")
  app$expect_values()
