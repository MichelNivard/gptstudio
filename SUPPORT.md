# Getting help with gptstudio

Thanks for using gptstudio! We are eager and excited to help. Thank you
for trying out our package!

Before filing an issue, there are a few places to explore and pieces to
put together to make the process as smooth as possible.
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/JamesHWade/gptstudio/issues/new).

- If it’s a question: if you are sure it’s from gptstudio and not
  another R question. Please file an issue. If the package grows in
  popularity, you may try [Posit
  Community](https://community.rstudio.com/) or StackOverflow. There are
...
requests](https://github.com/JamesHWade/gptstudio/issues) to make sure
