...
This outlines how to propose a change to gptstudio. This is based on the
tidyverse team’s contributing guide.
...
issue and make sure someone from the team agrees that it’s needed. Maybe
we could work on it together! If you’ve found a bug, please file an
issue that illustrates the bug with a minimal
[reprex](https://www.tidyverse.org/help/#reprex) (this will also help
you write a unit test, if needed). If you aren’t sure how to create the
reprex (it can be tricky with gptstudio interactive tools), please just
describe your issue as best you can.

### Pull request process

- Fork the package and clone onto your computer. If you haven’t done
  this before, we recommend using
  `usethis::create_from_github("MichelNivard/gptstudio", fork = TRUE)`.
